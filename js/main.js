                ...
                <ul class="nav-links">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="submenu">
                                ...
                                <a href="b2u6.html"> <i class="fa fa-gears fa-lg" aria-hidden="true"></i> Book 2 Unit 6 Vocabulary</a>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="submenu">
                            ...
                            <a href="alphabet_detail.html"><i class="fa fa-gears fa-lg" aria-hidden="true"></i> Alphabet Detail</a>
                        </ul>
                    </li>
