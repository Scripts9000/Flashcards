        ...
        <header>
            <nav>
                ...
                <ul class="nav-links">
                    ...
                    <li>
                    <a href='https://ko-fi.com/L3L8R1QN8' target='_blank'><img height='36' style='border:0px;height:36px;' src='kofi_s_tag_dark.webp' border='0' alt='Buy Me a Coffee at ko-fi.com' /></a>
                    </li>
                </ul>
            </nav>
        </header>
